...
multijoueur. PENDING : 017 (Gemini), 049, 050 — 009 clos le 2026-06-10 (packaging pip).
...
(image_generator 18). ⚠ Re-test ComfyUI réel utilisateur en attente.
**2026-06-11 : branche `image-gen` (a03edf5) ET packaging pip (fbe8b6e) mergés dans `main`**
(conflits doc/mémoire résolus à la main).
